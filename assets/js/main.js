...
const modalViews = document.querySelectorAll(".Activitys__modal"),
  modalBtns = document.querySelectorAll(".Activitys__button"),
  modalCloses = document.querySelectorAll(".Activitys__modal-close");
